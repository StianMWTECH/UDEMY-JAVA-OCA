package UDEMY_COURSE._2_working_with_java_data_types;
...
//        wrappers();
    ...
    public static void primitives(){
        ...
        float ff1 = 1L;  // long promoted to float
        ...
        short s1 = 'a'; // 97 is in range of

        char cc = 'a';   // chars in single quotes (Unicode 97)
        short s2 = cc;   // does not work with a variable (unless cc is a
...
//        
        ...
        System.out.println(0 % 3);// 0
            ...
            System.out.println("Output is "+ a + b);// Output is 32 (WEIRD)
